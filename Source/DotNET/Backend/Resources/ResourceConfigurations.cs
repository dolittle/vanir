...
namespace Dolittle.Vanir.Backend.Resources
{
    public class ResourceConfigurations : IResourceConfigurations
    {
        ...
        private readonly Dictionary<TenantId, Dictionary<Type, ResourceConfiguration>> _resourceConfigurationsByTenants = new();
        ...
        public TResource GetFor<TResource>(TenantId tenantId) where TResource : ResourceConfiguration
        {
